...
class _PostCardState extends State<PostCard> with SingleTickerProviderStateMixin {
  ...
  Future<void> _showCommentsBottomSheet(BuildContext context) async {
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => CommentsBottomSheet(postId: _localPost.id, token: token),
    );
  }
...
class _PostHeader extends StatelessWidget {
  ...
  void _showReportSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (ctx) => ReportContentSheet(
        contentId: post.id,
        contentType: 'post',
        contentTitle: post.userName,
      ),
    );
  }
...
class _MediaContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => onOpenImage?.call(post.mediaUrl, heroTag),
      child: Hero(
        tag: heroTag,
        child: CachedNetworkImage(
