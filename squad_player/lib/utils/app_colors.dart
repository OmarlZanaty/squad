...
class AppColors {
  ...
  // Primary Colors - Green Theme (from logo)
  static const Color primary = Color(0xFF2BC9A8);  // Green from logo
  static const Color primaryDark = Color(0xFF2BC9A8);
  static const Color primaryLight = Color(0xFF2BC9A8);
  ...
  // Dark Mode Accent Colors - TEAL/CYAN (USER REQUESTED COLOR)
  static const Color darkAccent = Color(0xFF38DBBE);  // NEW TEAL COLOR #38dbbe
  static const Color darkAccentDark = Color(0xFF2BC9A8);  // Slightly darker variant

  // Background Colors
  static const Color background = Color(0xFFF5F7FA);
  static const Color backgroundLight = Color(0xFFF5F5F5);
  static const Color backgroundDark = Color(0xFF1A1F2E);  // Dark navy background (from image)
  ...
  // Status Colors
  static const Color success = Color(0xFF2BC9A8);
  static const Color error = Color(0xFFF44336);
  static const Color warning = Color(0xFFFF9800);
  static const Color info = Color(0xFF2196F3);

  // Card Colors (for player cards)
  static const Color cardDark = Color(0xFF252B3B);  // Darker cards for dark mode (from image)
  ...
  static const Color borderDark = Color(0xFF2A3142);  // Dark mode border (from image)
  ...
  static const LinearGradient primaryGradient = LinearGradient(
    colors: [Color(0xFF2BC9A8), Color(0xFF2BC9A8)],
  ...
  // Dark Mode Gradient - NEW TEAL COLOR
  static const LinearGradient darkAccentGradient = LinearGradient(
    colors: [Color(0xFF38DBBE), Color(0xFF2BC9A8)],  // NEW TEAL gradient
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
